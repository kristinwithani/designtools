    ...
    <div className="animation-controls">
      ...
      <div className="panel-row panel-sliders">
        <div className="slider-group">
          <label className="slider-label">speed <span className="slider-value">{params.speed.toFixed(1)}s</span></label>
        ...
        <div className="slider-group">
          <label className="slider-label">intensity <span className="slider-value">{params.intensity}°</span></label>
      ...
      <div className="panel-row panel-sliders">
        <div className="slider-group">
          <label className="slider-label">stagger <span className="slider-value">{params.staggerOffset}ms</span></label>
        ...
        <div className="slider-group">
          <label className="slider-label">drift <span className="slider-value">{params.drift}px</span></label>
      ...
      <div className="panel-row panel-sliders">
        <div className="slider-group">
          <label className="slider-label">scale <span className="slider-value">{(params.scale * 100).toFixed(0)}%</span></label>
        ...
        <div className="slider-group">
          <label className="slider-label">opacity <span className="slider-value">{(params.opacity * 100).toFixed(0)}%</span></label>
